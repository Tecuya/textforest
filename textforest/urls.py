...
urlpatterns = [
    ...
    path('xhr/relations_for_node_slug/<slug>', forest.views.xhr_relations, name='xhr_relations_for_slug'),
    path('xhr/relations_for_node_slug/<slug>/<text>', forest.views.xhr_relations, name='xhr_relations_for_text'),
